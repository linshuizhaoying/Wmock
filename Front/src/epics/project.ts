...
import { projectList, unJoinProjectList, demoList } from '../service/api'

import { ERROR_PROJECT, FETCH_PROJECT, RECEIVE_PROJECT, FETCH_UNJOINPROJECT, RECEIVE_UNJOINPROJECT, FETCH_DEMO, RECEIVE_DEMO } from '../constants/project';
...
action$.ofType(FETCH_UNJOINPROJECT)
  ...
  export default combineEpics(fetchProject, fetchUnJoinProject, fetchDemo);